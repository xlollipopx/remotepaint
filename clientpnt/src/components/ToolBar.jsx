...
const Toolbar = () => {
    ...
    return (
        <div className="toolbar">
            ...
            <button className="toolbar__btn circe" onClick={() => toolState.setTool(new Circle(canvasState.canvas))}></button>
            ...
            <button className="toolbar__btn save" style={{ marginLeft: 20 }} onClick={() => download()}></button>
